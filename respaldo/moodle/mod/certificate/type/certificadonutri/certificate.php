...
certificate_print_text($pdf, $x, $y + 82, 'C', $fontsans, '', 30, fullname($USER));
//certificate_print_text($pdf, $x, $y + 158, 'C', $fontsans, '', 20, get_string('statement', 'certificate'));
certificate_print_text($pdf, $x, $y + 134, 'C', $fontsans, '', 20, format_string($course->fullname));
certificate_print_text($pdf, $x, $y + 168, 'C', $fontsans, '', 14,  certificate_get_date($certificate, $certrecord, $course));
certificate_print_text($pdf, $x, $y + 204, 'C', $fontserif, '', 10, certificate_get_grade($certificate, $course));
certificate_print_text($pdf, $x, $y + 214, 'C', $fontserif, '', 10, certificate_get_outcome($certificate, $course));
